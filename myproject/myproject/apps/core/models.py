...
def object_relation_base_factory(
        ...
        is_required=False):
    """
    Return a mixin class for generic foreign keys using
    ...
    Parameters:
        ...
        generate a title for the field column of the content
        object in the Admin
        add_related_name: a boolean value indicating, that a
        related name for the generated content type foreign key
        should be added. This value should be true, if you use
        more than one ObjectRelationBase in your model
    """
    p = ''
    if prefix:
        p = f'{prefix}_'
